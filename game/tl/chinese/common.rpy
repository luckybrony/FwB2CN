...
translate chinese strings:
    ...
    new "辅助功能菜单。使用上下箭头进行导航，按回车键激活按钮和栏。"
    ...
    new "此菜单上的选项旨在提高易用性。它们可能并不适用于所有项目，某些选项同时开启可能会导致游戏无法正常游玩。这不是游戏或引擎的问题。为了在更改字体时获得最佳效果，请尽量保持文本大小与原始大小相同。"
    ...
    new "这个存档是在另一个设备上创建的。恶意构建的存档文件可能会损害您的计算机。您信任这个存档的创建者和所有可能更改文件的人吗?"
    ...
    new "本程序包含许多许可证下的开源软件，包括MIT许可证和GNU较宽松通用公共许可证。完整的软件列表，包括完整源代码的链接，可以在{a=https://www.renpy.org/l/license}这里{/a}找到。"
    ...
    new "启用朗诵剪贴板。按 “shift+C ”可禁用。"

    # renpy/common/00preferences.rpy:700
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "自朗诵功能将会读出 \"[renpy.display.tts.last]\". 按 'alt+shift+V' 可禁用."
    ...
    new "在连接到Ren'Py Sync服务器时发生未知错误。"

    # renpy/common/00sync.rpy:267
    old "The Ren'Py Sync server does not have a copy of this sync. The sync ID may be invalid, or it may have timed out."
    new "Ren'Py Sync服务器没有此同步数据副本。同步ID可能无效，或者已超时。"
    ...
    new "这将上传您的保存到{a=https://sync.renpy.org}Ren'Py同步服务器{/a}。\n你想继续吗?"
    ...
    new "您可以使用此ID在另一台设备上下载您的存档。\n此同步数据将在一小时后失效。\nRen'Py同步由{a=https://www.renpy.org/sponsors.html}Ren'Py的赞助商{/a}支持。"
    ...
    new "这台计算机图像显示遇到了问题：[problem]."

    # renpy/common/00gltest.rpy:255
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "它的显卡驱动可能过时或不能正常运行。这可能导致缓慢或不正确的图形显示。"

    # renpy/common/00gltest.rpy:259
    old "The {a=edit:1:log.txt}log.txt{/a} file may contain information to help you determine what is wrong with your computer."
    new "{a=edit:1:log.txt}log.txt{/a}文件可能包含能帮助您查明计算机出了什么问题的信息。"

    # renpy/common/00gltest.rpy:264
    old "More details on how to fix this can be found in the {a=[url]}documentation{/a}."
    new "关于如何解决这个问题的更多细节可以在{a=[url]}文档{/a}中找到。"
    ...
    new "将traceback.txt文件作为BBcode复制到剪贴板，用于https://lemmasoft.renai.us/等论坛。"
    ...
    new "将traceback.txt文件复制到剪贴板，作为Markdown 用于发布到Discord。"
